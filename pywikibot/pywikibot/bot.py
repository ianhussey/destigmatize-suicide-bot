...
__version__ = '$Id: 1d9565299509c006a0947130f2d588ab2f905712 $'
...
def handle_args(args=None, do_help=True):
    ...
    if config.verbose_output:
        ...
        # replacement with `$Id: 1d9565299509c006a0947130f2d588ab2f905712 $`
        # or `$Id: 1d9565299509c006a0947130f2d588ab2f905712 $`.
        m = re.search(r"\$Id"
